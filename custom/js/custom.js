...
var classCustom 	= function()
{
	...
	main.updateData 	= function()
	{
		...
		if(index != -1)
		{
			color = timeline.config.events[index].gcolor;
		
			switch(timeline.config.events[index].group)
			{
				case "Metrics Landscape Begins To Change" : 
				...
				case "New Products Hit the Market" : 
				...
				case "World Class Investors Come to the Table" :
				...
				case "Impact Companies Make It Big" :
				...
				case "Institutions Pick Up the Baton" :
				...
				case "Academic Institutions Join the Ranks" : 
